...
void Application::mainMenu() {
  ...
  TTF_Font* hintFont = TTF_OpenFont(current_asset_bundle.FONT_MENU_HINT_PATH.c_str(), 20);
  ...
  SDL_Texture* titleTexture = IMG_LoadTexture(renderer, current_asset_bundle.MENU_BACKGROUND_PATH.c_str());
